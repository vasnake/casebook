...
Понадобится день-два (7).
День седьмой: Дела общей юрисдикции. Проверить работу на разных запросах. Проверить работу в винде.
Написать внятную доку: что сделано, что еще можно сделать, что имеем в итоге.
...
Сервис на Монге можно сделать дней за 10 - без поиска, простая выдача перечней дел, сторон и проч.
