...
Сервис на Монге можно сделать за 5-10 дней - без поиска, простая выдача перечней дел, сторон и проч.
Без навороченной структуры, самый минимум.
Примитивно, зато работает. Потом можно постепенно прикручивать поиск, выдачу XML, экспорт в XLS и проч.

Хранение в SQL потребует больше времени, раза в полтора-два.
...
написать парсеры, загрузчики. Короче, SQL предьявляет строгие требования к качеству данных. Монга - нет.
